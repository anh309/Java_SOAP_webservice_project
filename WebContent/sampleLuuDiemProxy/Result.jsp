...
<nav class="navbar navbar-default" style="margin-bottom:0px">
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse  large-8 medium-8 small-12 columns navbar-right menumau" id="bs-example-navbar-collapse-1" style="float:right">
            ...
            <li><a href="../sampleAProxy/nhom.html">Nhóm</a></li>
...
case 2:
        gotMethod = true;
        java.lang.String getEndpoint2mtemp = sampleLuuDiemProxyid.getEndpoint();
...
case 5:
        ...
        sampleLuuDiemProxyid.setEndpoint(endpoint_0idTemp);
break;
case 10:
        gotMethod = true;
        a.LuuDiem getLuuDiem10mtemp = sampleLuuDiemProxyid.getLuuDiem();
if(getLuuDiem10mtemp == null){
%>
	<%=getLuuDiem10mtemp %>
	<%
}else{
        if(getLuuDiem10mtemp!= null){
        String tempreturnp11 = getLuuDiem10mtemp.toString();
        %>
	<%=tempreturnp11%>
	<%
        }}
...
case 13:
        ...
        String score_2id=  request.getParameter("score18");
            java.lang.String score_2idTemp = null;
        if(!score_2id.equals("")){
         score_2idTemp  = score_2id;
        }
        java.lang.String gameFlap13mtemp = sampleLuuDiemProxyid.gameFlap(name_1idTemp,score_2idTemp);
if(gameFlap13mtemp == null){
%>
	<%=gameFlap13mtemp %>
	<%
}else{
        String tempResultreturnp14 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(gameFlap13mtemp));
        %>
<span style="display: none">	<%= tempResultreturnp14 %> </span>
	<%
}
break;
}
...
<div style=" width: 350px;  margin: auto; position: relative; margin-top: 10px; margin-bottom: 10px">
	<%
...
%>
	...
	<%
        ...
        %>
        <h3>fly bird</h3>
	<p>Điểm cao nhất: <span> <%= tempResultreturnp21 %></span></p>
	<%
}
%>
		<form>
			<INPUT TYPE="HIDDEN" NAME="method" VALUE="<%=org.eclipse.jst.ws.util.JspUtils.markup("13")%>">
			<p style="float: left; line-height: 10px; margin: 0; padding-top: 10px; padding-right: 10px"> Người chơi mới: </p>
			<input type="text" name="name16" placeholder="Nhập tên của bạn" style="width: 60%"> 
			<input type="hidden" name="score18" value="0" id="sc"> <br> 
			<input type="submit" id="restart_btn" value="Chơi lại">
		</form>
