...
<jsp:useBean id="sampleSendMailProxyid" scope="session" class="a.SendMailProxy" />
<%
if (request.getParameter("endpoint") != null && request.getParameter("endpoint").length() > 0)
sampleSendMailProxyid.setEndpoint(request.getParameter("endpoint"));
%>
...
<%
        ...
        String subject_3id=  request.getParameter("subject20");
            java.lang.String subject_3idTemp = null;
        if(!subject_3id.equals("")){
         subject_3idTemp  = subject_3id;
        }
        String text_4id=  request.getParameter("text22");
            java.lang.String text_4idTemp = null;
        if(!text_4id.equals("")){
         text_4idTemp  = text_4id;
        }
        boolean sendMail13mtemp = sampleSendMailProxyid.sendMail(acc_1idTemp,pass_2idTemp,subject_3idTemp,text_4idTemp);
        String tempResultreturnp14 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(sendMail13mtemp));
        %>
        <main class="container" align="center" style="height:400px"><p style="margin-bottom: 15px; margin-top: 25px; font-size: 36px; font-weight: bold; ">Xác nhận Mail đã gửi: <%= tempResultreturnp14 %></p></main>
