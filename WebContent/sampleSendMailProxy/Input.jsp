...
<INPUT class="medium-3"  style="width: 100px" TYPE="HIDDEN" NAME="method" VALUE="<%=org.eclipse.jst.ws.util.JspUtils.markup("13")%>">
<div class="col-md-4 col-md-offset-3">
<p style="margin-bottom: 15px; margin-top: 25px; font-size: 48px; font-weight: bold; ">Gửi Mail</p>
<INPUT  TYPE="email" NAME="acc16" SIZE=20 placeholder="Tài khoản Gmail">
<INPUT  TYPE="password" NAME="pass18" SIZE=20 placeholder="Mật khẩu">
<INPUT class="col-md-7" TYPE="TEXT" NAME="subject20" SIZE=20 placeholder="Tiêu đề">


</div>
<textarea class="col-md-7 col-md-offset-3"  name="text22" id="" cols="30" rows="10" placeholder="Nội dung"></textarea>
<div style="clear:both">
<div class="col-md-12">
	<div class="col-md-3"></div>
	<INPUT  class=" col-md-2 button round" TYPE="SUBMIT" VALUE="Gửi">
	</div>
</div>
</FORM>
</main >
